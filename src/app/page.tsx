    ...
    <main className="bg-[#353966] min-h-screen">
      ...
      <section className="flex justify-between mt-8 max-md:max-w-full max-md:flex-wrap pb-10">
        <div className="left-boxes">
          <div
            id="today's picks"
            className="shadow-[8px_8px_12px_0px_rgba(32,41,143,0.25),8px_8px_20px_0px_rgba(32,41,143,0.25)_inset] bg-[#6A5AFA] self-stretch flex flex-col px-5 lg:py-0.25 2xl:py-1 rounded-3xl max-md:max-w-full ml-16 max-md:ml-0 lg:ml-22 2xl:ml-20 mb-2"
          >
